        ...
        <div class="container">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <p class="text-white link-nav"><a href="index.php">Home </a> <span class="lnr lnr-arrow-right"></span> <a href="portfolio.php"> Portfolio</a></p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        <h4>About Me</h4>
                        <p>
                            I'm a Full Stack Django | ReactJS Developer. Just recently started learning React to compliment my Django web development to fit in for job placements, I've worked on e-commerce websites, real time chatting apps, blog apps, worked with allauth authentication,
                            payment gateways like Paystack, Stripe, etc;
                        </p>
                        <p class="footer-text">
