            ...
            <div class="row d-flex justify-content-center">
                <div class="menu-content  col-lg-7">
                    <div class="title text-center">
                        ...
                        <p> We provide Web Design well Design and accomodating programms and software for all types of programms to provide easy access to the world... and solve the worlds problem at large</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-services">
                        ...
                        <p>
                            “A designer knows he has achieved perfection not when there is nothing left to add, but when there is nothing left to take away” That the role we play on your design...
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-services">
                        ...
                        <p>
                            The world next ravelleing technology beast putting information at the very tip of your finger.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-services">
                        ...
                        <p>
                            guaranteed desig the Application design and mobile application.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
            ...
            <div class="row d-flex justify-content-center">
                <div class="menu-content pb-70 col-lg-8">
                    <div class="title text-center">
                        ...
                        <p>Well developed rsponsive site and good runing background</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        <p class="footer-text">
                            ...
                            </script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://success.net" target="_blank">success.net</a>
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
